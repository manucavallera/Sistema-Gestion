...
export default function InicioPage() {
    ...
    datasets: [
      {
        ...
        pointRadius: 5,
        tension: 0.4, // Agrega esta propiedad para suavizar y conectar la línea
        spanGaps: true, // Permite conectar puntos incluso si hay valores faltantes
        borderWidth: 2, // Asegura un grosor visible para la línea
  ...
  // Verificar que `lineChartData` tiene datos antes de renderizar
  console.log("Datos de LineChart:", lineChartData);
