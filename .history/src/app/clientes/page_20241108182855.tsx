...
const ClientesPage: React.FC = (): JSX.Element => {
  ...
  try {
    ...
    if (Array.isArray(response)) {
      ...
      console.error("La respuesta de la API no es un arreglo:", response);
      setClientes([]); // Establece un arreglo vacío si la respuesta no es válida
      setError("La respuesta de la API no es un arreglo.");
    }
  } catch (err) {
    console.error("Error al cargar los clientes:", err);
    setClientes([]); // Establece un arreglo vacío en caso de error
