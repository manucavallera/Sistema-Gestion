...
interface Proveedor {
  id: number;
  nombre: string; // Cambié de razonSocial a nombre
  direccion: string;
  cuit: string;
  zona: string;
}
...
const ProveedoresPage: React.FC = (): JSX.Element => {
  ...
  const guardarProveedor = async () => {
    if (
      nuevoProveedor.nombre && // Cambié razonSocial por nombre
      ...
      try {
        ...
        setNuevoProveedor({ nombre: "", direccion: "", cuit: "", zona: "" });
    ...
    <div className='p-4 bg-background'>
      ...
      <div className='mb-4'>
        <input
          type='text'
          placeholder='Nombre'
          value={nuevoProveedor.nombre} // Cambié razonSocial por nombre
          onChange={
            (e) =>
              setNuevoProveedor({ ...nuevoProveedor, nombre: e.target.value }) // Cambié razonSocial por nombre
          }
      ...
      <table className='min-w-full border border-gray-200'>
        <thead>
          <tr className='bg-gray-100'>
            ...
            {/* Cambié Razón Social por Nombre */}
