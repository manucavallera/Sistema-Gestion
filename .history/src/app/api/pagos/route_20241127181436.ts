...
export async function POST(request: NextRequest) {
  try {
    ...
    const totalDebe = Number(movimiento.monto); // Asegúrate de que esto sea un número
    const totalPagado = Number(nuevoPago.monto); // Asegúrate de que esto sea un número
