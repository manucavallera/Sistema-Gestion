...
export async function POST(request: NextRequest) {
  try {
    ...
    if (clienteId) {
      ...
      const nuevoHaber = haberActual + monto; // Aumentar el haber
      const nuevoSaldo = debeActual - nuevoHaber; // Calcular el nuevo saldo
    ...
    if (proveedorId) {
      ...
      const nuevoHaberProveedor = haberProveedorActual + monto; // Aumentar el haber del proveedor
