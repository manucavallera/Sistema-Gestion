...
async function actualizarSaldoProveedor(
  ...
  try {
    ...
    if (estado === "COMPLETADO") {
      nuevoSaldo = nuevoSaldo.sub(totalDecimal); // Disminuir saldo si el pago está completado
    } else if (estado === "CANCELADO") {
      nuevoSaldo = nuevoSaldo.add(totalDecimal); // Aumentar saldo si el pago está cancelado
    }
