...
async function actualizarSaldoProveedor(
  ...
  try {
    ...
    // Actualizar el saldo según el estado
    if (estado === "COMPLETADO" || estado === "CANCELADO") {
      nuevoSaldo = nuevoSaldo.sub(totalDecimal); // Disminuir saldo si el pago está completado o cancelado
    } else if (estado === "PENDIENTE") {
      nuevoSaldo = nuevoSaldo.add(totalDecimal); // Aumentar saldo si el pago está pendiente
    }
