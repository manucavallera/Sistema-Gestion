  ...
  useEffect(() => {
    const cargarComprasYProveedores = async () => {
      ...
      try {
        ...
        setCompras(comprasResponse.filter((compra: Compra) => compra && compra.id && compra.proveedorId && compra.total && compra.fecha)); // Filtrar compras indefinidas
            ...
            compra ? (
              <tr key={compra.id}>
                <td className='border border-gray-300 p-2'>
                  ...
                  )?.razonSocial || "Proveedor no encontrado"}
                </td>
                <td className='border border-gray-300 p-2'>
                  {compra.total}
                </td>
