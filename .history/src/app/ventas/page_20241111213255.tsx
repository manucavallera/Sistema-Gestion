...
const VentasPage: React.FC = (): JSX.Element => {
  ...
  const guardarVenta = async () => {
    ...
    try {
      let response;
      if (ventaEditando) {
        response = await updateSale(ventaEditando.id, nuevaVenta);
        const updatedVenta = response; // Cambiado para que coincida con la respuesta esperada
        setVentas(
          ventas.map((venta) =>
        ...
        response = await createSale(nuevaVenta);
        const ventaCreada = response; // Cambiado para que coincida con la respuesta esperada
