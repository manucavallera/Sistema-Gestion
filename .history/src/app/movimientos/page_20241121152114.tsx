...
const MovimientosPage = () => {
  ...
  const fetchClientesYProveedores = async () => {
    ...
    try {
      ...
      console.error("Error al buscar clientes y proveedores:", error);
    }
  };
        ...
        <div>
          <label className='block text-sm font-medium text-gray-700'>
            ...
            <select
              ...
              className='mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500'
              disabled={proveedorId !== null} // Deshabilitar si hay un proveedor seleccionado
            >
        ...
        <div>
          <label className='block text-sm font-medium text-gray-700'>
            ...
            <select
              ...
              className='mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500'
              disabled={clienteId !== null} // Deshabilitar si hay un cliente seleccionado
            >
          ...
          return (
            ...
            >
              ...
              <select
                ...
                onChange={(e) =>
                  handleStatusChange(movimiento.id, e.target.value)
                }
