...
const MovimientosPage = () => {
  ...
  const handleEditMovimiento = async (e: React.FormEvent) => {
    ...
    if (movimientoAEditar) {
      // Validaciones
      if (movimientoAEditar.monto <= 0) {
        console.error("El monto debe ser un número positivo.");
        return;
      }

      if (
        movimientoAEditar.tipo !== "CREDITO" &&
        movimientoAEditar.tipo !== "DEBITO"
      ) {
        console.error("El tipo debe ser 'CREDITO' o 'DEBITO'.");
        return;
      }
