  ...
  return (
    <div>
      ...
      <ul>
        {cheques.map((cheque) => (
          <li key={cheque.id}>
            {cheque.numero} - {cheque.monto} - {new Date(cheque.fechaEmision).            {cheque.numero} - {cheque.monto} - {new Date(cheque.fechaEmision).toLocaleDateString()} - {new Date(cheque.fechaVencimiento).toLocaleDateString()}
          </li>
        ))}
      </ul>
    </div>
