...
export const getAllSales = async () => {
  try {
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        `Error al obtener las ventas: ${error.response.data.message}`
      );
    } else {
...
export const getSaleById = async (id: number) => {
  try {
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        `Error al obtener la venta con ID ${id}: ${error.response.data.message}`
      );
    } else {
...
export const createSale = async (venta: {
  ...
  try {
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        `Error al crear la venta: ${error.response.data.message}`
      );
    } else {
...
export const updateSale = async (
  ...
  try {
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        `Error al actualizar la venta con ID ${id}: ${error.response.data.message}`
      );
    } else {
...
export const deleteSale = async (id: number) => {
  try {
    ...
    if (axios.isAxiosError(error) && error.response) {
      throw new Error(
        `Error al eliminar la venta con ID ${id}: ${error.response.data.message}`
      );
    } else {
