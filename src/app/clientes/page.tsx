  ...
  return (
    <div className='p-6'>
      ...
      <form onSubmit={handleSubmit} className='mb-4 grid grid-cols-2 gap-4'>
        {["razonSocial", "direccion", "cuit", "zona", "telefono", "email"].map(
          (field, index) => (
            <input
              key={index}
        ...
        <input
          type='number'
          placeholder='Debe Inicial'
          value={clienteActual?.debe || ""}
          onChange={(e) =>
            setClienteActual({
              ...clienteActual,
              debe: Number(e.target.value),
            })
          }
          className='border p-2 mb-2 w-full'
        />
        <input
          type='number'
          placeholder='Haber Inicial'
          value={clienteActual?.haber || ""}
          onChange={(e) =>
            setClienteActual({
              ...clienteActual,
              haber: Number(e.target.value),
            })
          }
          className='border p-2 mb-2 w-full'
        />
